...
- Added a render-smoke test for the composer dialog (mount, then click "Compose this part" and confirm the nested editor mounts) — this class of self-referential UI is exactly where a stale hook dependency or ordering bug likes to hide, and `tsc` doesn't catch it.
